$(document).ready(function(){
	$("span.quote").each(function(i, value){
		...
		if($(this).attr("name") != null && $(this).attr("name") != ''){
			...
			html += '<img src="quote_icon.png" alt="Quote" title="Quote" />';
			html += ' Originally posted by '+ $(this).attr("name");
			if($(this).attr("src") != null && $(this).attr("src") != ''){
				html += ' <a href="' + $(this).attr("src") + '">';
				html += '<img class="quote-source" src="viewpost-right.png" alt="View Source" title="View Source" />';
				html += '</a>';
			}
			html += '</div>';
	...
	$("div.quote-arrow").css({'background':'transparent url(quote-left.png) no-repeat left','display':'block','width':'9px','height':'13px','position':'absolute','top':'5px','left':'-9px'});
